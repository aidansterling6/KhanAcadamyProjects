...
var lazers = [];
var mirrors = [{x1:0,y1:400,x2:400,y2:400}, {x1:335,y1:176,x2:354,y2:57}, {x1:0,y1:0,x2:440,y2:0}, {x1:29,y1:219,x2:140,y2:205}, {x1:192,y1:242,x2:273,y2:205}];
for(var i = 0; i < mirrors.length;i++){
    if(mirrors[i].x2 < mirrors[i].x1){
        var tempvar = mirrors[i].x1;
        mirrors[i].x1 = mirrors[i].x2;
        mirrors[i].x2 = tempvar;
    }
    if(mirrors[i].y2 > mirrors[i].y1){
        var tempvar = mirrors[i].y1;
        mirrors[i].y1 = mirrors[i].y2;
        mirrors[i].y2 = tempvar;
    }
}
...
draw = function() {
    ...
    lazerSpawn(Xpos, Ypos, Xpos2, Ypos2, 20);
    lazer();
};
